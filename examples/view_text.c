...
int main(int argc, char *argv[])
{
	...
	shovelerComponentUpdateCanonicalConfigurationOptionBool(modelComponent, SHOVELER_COMPONENT_MODEL_OPTION_ID_EMITTER, false);
	shovelerComponentUpdateCanonicalConfigurationOptionBool(modelComponent, SHOVELER_COMPONENT_MODEL_OPTION_ID_CASTS_SHADOW, true);
