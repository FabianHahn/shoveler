...
int main(int argc, char *argv[])
{
	...
	shovelerViewAddEntity(view, 1);
	shovelerViewAddEntityDrawable(view, 1, cubeDrawableConfiguration);
	...
	shovelerViewAddEntity(view, 2);
	shovelerViewAddEntityModel(view, 2, cubeModelConfiguration);
	shovelerViewAddEntityPosition(view, 2, 0.0, 0.0, 5.0);
	...
	shovelerViewAddEntity(view, 3);
	shovelerViewAddEntityDrawable(view, 3, quadDrawableConfiguration);
	shovelerViewAddEntityModel(view, 3, planeModelConfiguration);
	shovelerViewAddEntityPosition(view, 3, 0.0, 0.0, 10.0);
	...
	shovelerViewAddEntity(view, 4);
	shovelerViewAddEntityDrawable(view, 4, pointDrawableConfiguration);
	shovelerViewAddEntityModel(view, 4, lightModelConfiguration);
	shovelerViewAddEntityLight(view, 4, lightConfiguration);
	shovelerViewAddEntityPosition(view, 4, 0.0, 2.0, 0.0);
...
static void updateGame(ShovelerGame *game, double dt)
{
	...
	time += dt;
	shovelerViewUpdateEntityPosition(view, 4, 2.0 * sin(time), 2.0 * cos(time), 0.0);
}
