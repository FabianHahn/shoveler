...
int main(int argc, char *argv[])
{
	...
	tileSprite->translation = shovelerVector2(-1.5f, -1.5f);
	tileSprite->scale = shovelerVector2(5.0f, 5.0f);
	...
	characterSprite->scale = shovelerVector2(1.0f, 1.0f);
...
static void shovelerSampleUpdate(ShovelerGame *game, double dt)
{
	...
	float characterWorldX = characterSprite->translation.values[0];
	float characterWorldY = characterSprite->translation.values[1];
