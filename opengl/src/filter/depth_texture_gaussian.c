...
ShovelerFilter* shovelerFilterDepthTextureGaussianCreate(
    ...
    GLsizei samples,
    float exponentialFactor) {
  DepthTextureGaussianFilter* depthTextureGaussianFilter =
      malloc(sizeof(DepthTextureGaussianFilter));
  ...
  depthTextureGaussianFilter->filterXFramebuffer =
      shovelerFramebufferCreateColorOnly(width, height, samples, 1, 32);
  depthTextureGaussianFilter->filterYFramebuffer =
      shovelerFramebufferCreateColorOnly(width, height, samples, 1, 32);

  depthTextureGaussianFilter->filterXMaterial =
      shovelerMaterialDepthTextureGaussianFilterGaussianFilterCreate(
          shaderCache,
          &depthTextureGaussianFilter->filter.inputTexture,
          &depthTextureGaussianFilter->filterSampler,
          width,
          height);
  shovelerMaterialDepthTextureGaussianFilterEnableExponentialLifting(
      depthTextureGaussianFilter->filterXMaterial, exponentialFactor);
  depthTextureGaussianFilter->filterYMaterial =
      shovelerMaterialDepthTextureGaussianFilterGaussianFilterCreate(
          shaderCache,
          &depthTextureGaussianFilter->filterXFramebuffer->renderTarget,
          &depthTextureGaussianFilter->filterSampler,
          width,
          height);
  shovelerMaterialDepthTextureGaussianFilterSetDirection(
      depthTextureGaussianFilter->filterYMaterial, false, true);
  depthTextureGaussianFilter->filter.outputTexture =
      depthTextureGaussianFilter->filterYFramebuffer->renderTarget;
  ...
  depthTextureGaussianFilter->filterModel = shovelerModelCreate(
      depthTextureGaussianFilter->filterQuad, depthTextureGaussianFilter->filterXMaterial);
  ...
  depthTextureGaussianFilter->filterSceneRenderPassOptions.renderState.blendDestinationFactor =
      GL_ONE;
  ...
  shovelerSceneAddModel(
      depthTextureGaussianFilter->filterScene, depthTextureGaussianFilter->filterModel);
...
static int filterDepthTextureGaussian(ShovelerFilter* filter, ShovelerRenderState* renderState) {
  DepthTextureGaussianFilter* depthTextureGaussianFilter =
      (DepthTextureGaussianFilter*) filter->data;
  ...
  depthTextureGaussianFilter->filterSceneRenderPassOptions.overrideMaterial =
      depthTextureGaussianFilter->filterXMaterial;
  rendered += shovelerSceneRenderPass(
      depthTextureGaussianFilter->filterScene,
      depthTextureGaussianFilter->filterCamera,
      NULL,
      depthTextureGaussianFilter->filterSceneRenderPassOptions,
      renderState);
...
static void freeDepthTextureGaussian(void* data) {
  ...
  shovelerShaderCacheInvalidateCamera(
      depthTextureGaussianFilter->shaderCache, depthTextureGaussianFilter->filterCamera);
