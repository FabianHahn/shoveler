...
static const char* fragmentShaderSource =
    ...
    ""
    "float gaussianKernel[9] = float[](0.048297, 0.08393, 0.124548, 0.157829, 0.170793, 0.157829, "
    "0.124548, 0.08393, 0.048297);\n"
    ""
...
ShovelerMaterial* shovelerMaterialDepthTextureGaussianFilterGaussianFilterCreate(
  ...
  GLuint vertexShaderObject =
      shovelerShaderProgramCompileFromString(vertexShaderSource, GL_VERTEX_SHADER);
  ...
  ShovelerMaterialDepthTextureGaussianFilterData* materialDepthTextureGaussianFilterData =
      malloc(sizeof(ShovelerMaterialDepthTextureGaussianFilterData));
  ...
  shovelerUniformMapInsert(
      material->uniforms,
      "liftExponential",
      shovelerUniformCreateIntPointer(&materialDepthTextureGaussianFilterData->liftExponential));
  shovelerUniformMapInsert(
      material->uniforms,
      "liftExponentialFactor",
      shovelerUniformCreateFloatPointer(
          &materialDepthTextureGaussianFilterData->liftExponentialFactor));
  shovelerUniformMapInsert(
      material->uniforms,
      "filterDirection",
      shovelerUniformCreateVector2Pointer(
          &materialDepthTextureGaussianFilterData->filterDirection));
  shovelerUniformMapInsert(
      material->uniforms,
      "inverseTextureSize",
      shovelerUniformCreateVector2(shovelerVector2(1.0f / width, 1.0f / height)));
  shovelerUniformMapInsert(
      material->uniforms,
      "textureImage",
      shovelerUniformCreateTexturePointer(texturePointer, samplerPointer));
