...
ShovelerMaterial* shovelerMaterialTileSpriteCreate(
  ...
  shovelerUniformMapInsert(
      materialData->material->uniforms,
      "tilesetColumn",
      shovelerUniformCreateIntPointer(&materialData->activeSpriteTilesetColumn));
  shovelerUniformMapInsert(
      materialData->material->uniforms,
      "tilesetRow",
      shovelerUniformCreateIntPointer(&materialData->activeSpriteTilesetRow));
...
void shovelerMaterialTileSpriteSetActiveTile(
    ShovelerMaterial* material, int tilesetColumn, int tilesetRow) {
  MaterialData* materialData = material->data;
...
void shovelerMaterialTileSpriteSetActive(
  ...
  shovelerMaterialTileSpriteSetActiveTile(
      material, spriteTile->tilesetColumn, spriteTile->tilesetRow);
  shovelerMaterialTileSpriteSetActiveTileset(material, spriteTile->tileset);
  shovelerMaterialTileSpriteSetActiveSprite(
      material, spriteTile->sprite.position, spriteTile->sprite.size);
}
