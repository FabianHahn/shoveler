...
ShovelerInput* shovelerInputCreate(ShovelerGame* game) {
  ...
  input->mouseButtonCallbacks =
      g_hash_table_new_full(g_direct_hash, g_direct_equal, freeMouseButtonCallback, NULL);
  input->cursorPositionCallbacks =
      g_hash_table_new_full(g_direct_hash, g_direct_equal, freeCursorPositionCallback, NULL);
  input->scrollCallbacks =
      g_hash_table_new_full(g_direct_hash, g_direct_equal, freeScrollCallback, NULL);
  input->windowSizeCallbacks =
      g_hash_table_new_full(g_direct_hash, g_direct_equal, freeWindowSizeCallback, NULL);
...
ShovelerInputKeyCallback* shovelerInputAddKeyCallback(
    ShovelerInput* input, ShovelerInputKeyCallbackFunction* callbackFunction, void* userData) {
...
ShovelerInputMouseButtonCallback* shovelerInputAddMouseButtonCallback(
    ShovelerInput* input,
    ShovelerInputMouseButtonCallbackFunction* callbackFunction,
    void* userData) {
...
ShovelerInputCursorPositionCallback* shovelerInputAddCursorPosCallback(
    ShovelerInput* input,
    ShovelerInputCursorPositionCallbackFunction* callbackFunction,
    void* userData) {
  ShovelerInputCursorPositionCallback* callback =
      malloc(sizeof(ShovelerInputCursorPositionCallback));
  callback->function = callbackFunction;
  callback->userData = userData;
...
ShovelerInputScrollCallback* shovelerInputAddScrollCallback(
    ShovelerInput* input, ShovelerInputScrollCallbackFunction* callbackFunction, void* userData) {
...
ShovelerInputWindowSizeCallback* shovelerInputAddWindowSizeCallback(
    ShovelerInput* input,
    ShovelerInputWindowSizeCallbackFunction* callbackFunction,
    void* userData) {
...
bool shovelerInputRemoveMouseButtonCallback(
    ShovelerInput* input, ShovelerInputMouseButtonCallback* callback) {
  return g_hash_table_remove(input->mouseButtonCallbacks, callback);
}

bool shovelerInputRemoveCursorPositionCallback(
    ShovelerInput* input, ShovelerInputCursorPositionCallback* callback) {
  return g_hash_table_remove(input->cursorPositionCallbacks, callback);
}

bool shovelerInputRemoveScrollCallback(
    ShovelerInput* input, ShovelerInputScrollCallback* callback) {
  return g_hash_table_remove(input->scrollCallbacks, callback);
}

bool shovelerInputRemoveWindowSizeCallback(
    ShovelerInput* input, ShovelerInputWindowSizeCallback* callback) {
...
static void freeKeyCallback(void* keyCallbackPointer) { free(keyCallbackPointer); }
...
static void freeScrollCallback(void* scrollCallbackPointer) { free(scrollCallbackPointer); }
