...
{
	ShovelerComponentType *componentType = shovelerComponentTypeCreate(shovelerComponentTypeNameCanvas, activateCanvasComponent, deactivateCanvasComponent, /* requiresAuthority */ false);
	shovelerComponentTypeAddDependencyConfigurationOption(componentType, shovelerComponentCanvasOptionKeyTileSprites, shovelerComponentTypeNameTileSprite, /* isArray */ true, /* isOptional */ false, /* liveUpdate */ NULL, /* updateDependency */ NULL);
...
{
	assert(strcmp(component->type->name, shovelerComponentTypeNameCanvas) == 0);
