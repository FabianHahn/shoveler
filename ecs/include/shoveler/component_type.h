...
typedef struct ShovelerComponentFieldStruct ShovelerComponentField; // forward declaration: component_field.h
 ...
 */
ShovelerComponentType *shovelerComponentTypeCreate(const char *id, int numFields, const ShovelerComponentField *fields);
