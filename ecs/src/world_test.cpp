...
public:
  virtual void SetUp() {
    ...
    ShovelerComponentSystem *componentSystem1 = shovelerSystemForComponentType(system, componentType1);
    ShovelerComponentSystem *componentSystem2 = shovelerSystemForComponentType(system, componentType2);
    ShovelerComponentSystem *componentSystem3 = shovelerSystemForComponentType(system, componentType3);
...
TEST_F(ShovelerWorldTest, updateAuthoritativeComponent) {
  ...
  ShovelerWorldEntity* entity1 = shovelerWorldAddEntity(world, entityId1);
  ShovelerComponent* component1 = shovelerWorldEntityAddComponent(entity1, componentType1Id);
  shovelerComponentDelegate(component1);
