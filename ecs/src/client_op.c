...
bool shovelerWorldApplyClientOp(ShovelerWorld* world, const ShovelerClientOp* clientOp) {
  ...
  case SHOVELER_CLIENT_OP_REMOVE_ENTITY:
    return shovelerWorldRemoveEntity(world, clientOp->removeEntity.entityId);
  case SHOVELER_CLIENT_OP_ADD_COMPONENT: {
  ...
  case SHOVELER_CLIENT_OP_REMOVE_COMPONENT: {
    ...
    return shovelerWorldEntityRemoveComponent(entity, clientOp->removeComponent.componentTypeId);
  }
  default:
    return false;
  }
