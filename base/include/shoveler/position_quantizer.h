...
{
	float diffX = (worldX - positionQuantizer->worldMin.values[0]) / positionQuantizer->worldSize.values[0];
...
{
	float diffY = (worldY - positionQuantizer->worldMin.values[1]) / positionQuantizer->worldSize.values[1];
