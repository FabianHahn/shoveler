...
static inline ShovelerProjectionPerspective shovelerProjectionPerspective(float fieldOfViewY, float aspectRatio, float nearClippingPlane, float farClippingPlane)
{
