...
static inline const ShovelerCollider2 *shovelerCollidersIntersect2(ShovelerColliders *colliders, const ShovelerBoundingBox2 *boundingBox)
{
	return shovelerCollidersIntersect2Filtered(colliders, boundingBox, /* filterCandidate */ NULL, /* filterCandidateUserData */ NULL);
}

static inline const ShovelerCollider3 *shovelerCollidersIntersect3(ShovelerColliders *colliders, const ShovelerBoundingBox3 *boundingBox)
{
	return shovelerCollidersIntersect3Filtered(colliders, boundingBox, /* filterCandidate */ NULL, /* filterCandidateUserData */ NULL);
}
