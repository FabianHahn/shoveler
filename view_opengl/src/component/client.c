...
ShovelerComponentType *shovelerComponentCreateClientType()
{
	...
	configurationOptions[SHOVELER_COMPONENT_CLIENT_OPTION_ID_POSITION] = shovelerComponentTypeConfigurationOptionDependency("position", shovelerComponentTypeIdPosition, /* isArray */ false, /* isOptional */ false, /* liveUpdate */ NULL, shovelerComponentLiveUpdateDependencyNoop);
